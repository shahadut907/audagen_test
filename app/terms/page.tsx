  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-2xl text-center">
        <p className="text-xs uppercase tracking-[0.12em] text-accent mb-4">TERMS OF SERVICE</p>
        <h1 className="font-display text-5xl md:text-6xl text-ink mb-6">Coming soon.</h1>
        <p className="text-ink2 text-lg mb-8">
          We are putting the finishing touches on our terms of service. In the meantime, reach out to{' '}
